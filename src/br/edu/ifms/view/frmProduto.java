...
import br.edu.ifms.tablemodel.ProdutoTableModel;
...
public class frmProduto extends javax.swing.JInternalFrame {
    ...
    public final void populaJComboBox() {
        ...
        DaoGenerico<Categoria> dao = new DaoGenerico<>();
        cmbCategoria.addItem("Selecione...");
        dao.listaTodos(Categoria.class).forEach((c) -> {
    ...
    public final void listarProduto() {
        ...
        DaoGenerico<Produto> dao = new DaoGenerico<>();
        modelo.setListaProduto(dao.listaTodos(Produto.class));
    ...
    public void editarProduto() {
        if (tblProduto.getSelectedRow() != -1) {
            Produto p = new DaoGenerico<Produto>()
                    .findById(Produto.class, (int) tblProduto.getValueAt(tblProduto.getSelectedRow(), 0));
            p.setNome(txtNome.getText());
            p.setPreco(Double.parseDouble(txtPreco.getText()));
            p.setDatacadastro(txtDataCadastro.getDate());
            p.setCategoria((Categoria) cmbCategoria.getSelectedItem());
            new DaoGenerico<>().saveOrUpdate(p);
            limparCampos(0);
            pesquisarProduto();
            populaJComboBox();
        }
    ...
    public void deletarProduto() {
        if (tblProduto.getSelectedRow() != -1) {
            ...
            dao.remove(Produto.class, p.getId());
        }
        limparCampos();
    }
    ...
    public void pesquisarProduto() {
        ProdutoTableModel modelo = new ProdutoTableModel();
        DaoGenerico<Produto> dao = new DaoGenerico<>();
        modelo.setListaProduto(dao.findByNome(Produto.class, txtPesquisar.getText(), "nome"));
        tblProduto.setModel(modelo);
        ajustaTabela();
    }
    ...
    public void selecionaProduto() {
        ...
        int id = (int) tblProduto.getModel().getValueAt(linhaSelecionada, 0);
        Produto p = dao.findById(Produto.class, id);
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(txtIdUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtIdCategoria, txtIdProduto, txtIdUsuario});
