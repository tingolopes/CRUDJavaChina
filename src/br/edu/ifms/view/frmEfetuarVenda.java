...
public class frmEfetuarVenda extends javax.swing.JInternalFrame {
    ...
    public void pesquisaDinamicaCliente() {
        ...
        listaCliente = dao.findByNome(Cliente.class, txtPesquisaCliente.getText(), "nome");
        ...
        if (txtPesquisaCliente.getText().isEmpty()) {
            ...
            for (Cliente percorrer : listaCliente) {
                listModel.addElement(percorrer.getId() + " - " + percorrer.getNome());
            }
            jListClientes.setModel(listModel);
        }
    }
    ...
    public void selecionaCliente() {
        ...
        cliente.setNome(dao.findById(Cliente.class, idCliente).getNome());
...
//            jButtonLimpaPesquisaCliente.setEnabled(false);
    ...
    public void pesquisaDinamicaProduto() {
        ...
        DaoGenerico<Produto> dao = new DaoGenerico<>();
        listaProduto = dao.findByNome(Produto.class, txtPesquisaProduto.getText(), "nome");
        DefaultListModel listModel = new DefaultListModel();
    ...
    public void selecionaProduto() {
        ...
        produto.setNome(dao.findById(Produto.class, idProduto).getNome());
        produto.setPreco(dao.findById(Produto.class, idProduto).getPreco());
    ...
    private void initComponents() {
        ...
        jButonInserirProduto = new javax.swing.JButton();
        ...
        jButonInserirProduto.setText("Inserir");
        jButonInserirProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButonInserirProdutoActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanelVendaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanelVendaLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanelVendaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanelVendaLayout.createSequentialGroup()
                                    .addComponent(txtQtdProd, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jButonInserirProduto)))))))
            .addGroup(jPanelVendaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanelVendaLayout.createSequentialGroup()
                    .addGap(4, 4, 4)
                    .addGroup(jPanelVendaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButonInserirProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButonInserirProdutoActionPerformed
    ...
    }//GEN-LAST:event_jButonInserirProdutoActionPerformed
    ...
    private javax.swing.JButton jButonInserirProduto;
