...
import br.edu.ifms.tablemodel.CategoriaTableModel;
...
public class frmCategoria extends javax.swing.JInternalFrame {
    ...
    public void listarCategoria() {
        ...
        modelo.setListaCategorias(dao.listaTodos(Categoria.class));
    ...
    public void editarCategoria() {
        if (tblCategoria.getSelectedRow() != -1) {
            ...
            c.setNome(txtNome.getText());
            c.setDescricao(txtDescricao.getText());
            c.setId((int) (tblCategoria.getValueAt(tblCategoria.getSelectedRow(), 0)));
            dao.saveOrUpdate(c);
        }
        limparCampos(0);
        pesquisarCategoria();
    ...
    public void deletarCategoria() {
        if (tblCategoria.getSelectedRow() != -1) {
            ...
            DaoGenerico<Categoria> dao = new DaoGenerico<>();
            c.setId((int) tblCategoria.getValueAt(tblCategoria.getSelectedRow(), 0));
            dao.remove(Categoria.class, c.getId());
        }
        listarCategoria();
    }
    ...
    public void pesquisarCategoria() {
        CategoriaTableModel modelo = new CategoriaTableModel();
        DaoGenerico<Categoria> dao = new DaoGenerico<>();
        modelo.setListaCategorias(dao.findByNome(Categoria.class, txtPesquisar.getText(), "nome"));
        tblCategoria.setModel(modelo);
        ajustaTabela();
    }
    ...
    public void selecionaItem() {
        ...
        Categoria categoria = dao.findById(Categoria.class, idCategoria);
