...
import br.edu.ifms.tablemodel.ClienteTableModel;
...
public class frmCliente extends javax.swing.JInternalFrame {
    ...
    public final void listarCliente() {
        ...
        DaoGenerico<Cliente> dao = new DaoGenerico<>();
        modelo.setListaClientes(dao.listaTodos(Cliente.class));
    ...
    public void editarCliente() {
        if (tblCliente.getSelectedRow() != -1) {
            ...
            a.setNome(txtNome.getText());
            a.setEndereco(txtEndereco.getText());
            a.setId((int) (tblCliente.getValueAt(tblCliente.getSelectedRow(), 0)));
            dao.saveOrUpdate(a);
        }
        limparCampos(0);
        pesquisarCliente();
    ...
    public void deletarCliente() {
        if (tblCliente.getSelectedRow() != -1) {
            ...
            a.setId((int) (tblCliente.getValueAt(tblCliente.getSelectedRow(), 0)));
            dao.remove(Cliente.class, a.getId());
        }
        limparCampos();
        listarCliente();
    }
    ...
    public void pesquisarCliente() {
        ClienteTableModel modelo = new ClienteTableModel();
        DaoGenerico<Cliente> dao = new DaoGenerico<>();
        modelo.setListaClientes(dao.findByNome(Cliente.class, txtPesquisar.getText(), "nome"));
        tblCliente.setModel(modelo);
        ajustaTabela();
    }
